...
RESULTS_ROOT = "./results/LightGBM_iterate-lag_sub"
        ...
        for sub in ["sub-01"]:
            ...
            for feature in FEATURES:
                ...
                for time_lag in np.arange(0, int(MAX_TIMELAG * 1000), WHISPER_SEG_LEN):
                    logging.info(f"Conducting mTRF for: Model '{FIXED_MODEL}', Context '{FIXED_CONTEXT_LEN}', Feature '{feature}', TimeLag {time_lag}ms...")
                    ...
                    np.save(os.path.join(results_dir, f"whisper-{feature}_timelg-{int(time_lag)}_r-obs.npy"), r)
